const social = new Div('.social', [
  ...
  new A({
    ...
    I('.fa.fa-fw.fa-3x.fa-linkedin-square')
  ]),
  new A({
    title: 'Resume',
    href: '',
    ...
    I('.fa.fa-fw.fa-3x.fa-file-pdf-o')
  ]),
  new A({
    title: 'Twitter',
    ...
    I('.fa.fa-fw.fa-3x.fa-twitter-square')
  ]),
  new A({
    title: 'Instagram',
